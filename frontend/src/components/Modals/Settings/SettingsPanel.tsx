...
const SettingsPanel: React.FunctionComponent<ISettingsPanelProps> = ({ onSelect, selected }) =>
  useObserver(() => (
    <div className={"settings-panel"}>
      {MyInfo.isHost && (
        <SettingsPanelItem
          panel={SettingsPanels.RoomSettings}
          onSelect={onSelect}
          selected={selected}
          icon={faDoorClosed}
          text={"Room Settings"}
      ...
      <SettingsPanelItem
        panel={SettingsPanels.Participants}
        onSelect={onSelect}
        selected={selected}
        icon={faUsers}
      ...
      />
      <SettingsPanelItem
        panel={SettingsPanels.MySettings}
        onSelect={onSelect}
        selected={selected}
        icon={faUserCog}
        text={"My Settings"}
      />
      <SettingsPanelItem
        panel={SettingsPanels.CameraSettings}
        onSelect={onSelect}
        selected={selected}
        icon={faVideo}
