...
const CreateDialog: React.FunctionComponent = () => {
    ...
    function handleCreateRoom() {
        ...
        try {
            ...
            NotificationService.add(
                NotificationService.createUINotification(e, NotificationType.Error)
            );
        }
    }
    ...
    return (
        <div className={"dialog-modal"}>
            ...
            <input
                data-private={"lipsum"}
                onBlur={() => setRoomNameValidationEnabled(true)}
                className={
                    "modal--input " +
                    (!roomNameValidationEnabled || roomNameIsValid() ? "" : "invalid")
                }
                onChange={(e) => {
            ...
            <input
                data-private={"lipsum"}
                onBlur={() => setUserNameValidationEnabled(true)}
                className={
                    "modal--input " +
                    (!userNameValidationEnabled || userNameIsValid() ? "" : "invalid")
                }
