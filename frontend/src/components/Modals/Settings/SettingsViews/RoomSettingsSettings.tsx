...
export const RoomSettingsSettings: React.FunctionComponent<ISettingsPanelProps> = ({
    events,
    handleChangesMade,
}) => {
        ...
        <div className={"settings-view"}>
            ...
            <label>
                <input
                    data-private={"lipsum"}
                    className={"modal--input"}
                    checked={newSettings.waitingRoom}
                    type={"checkbox"}
                    placeholder={"Name"}
                    onChange={(e) => {
                        setNewSettings({
            ...
            <label>
                On Disconnect
                <select
                    value={newSettings.hostDisconnectAction}
                    onChange={(e) => {
                        setNewSettings({
                            ...newSettings,
                ...
                >
                    <option value={HostDisconnectAction.TRANSFER_HOST}>
                        Transfer host to random person
                    </option>
                    <option value={HostDisconnectAction.CLOSE_ROOM}>
