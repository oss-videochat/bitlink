...
const SettingsPanelItem: React.FunctionComponent<ISettingsPanelItemProps> = ({panel, selected, onSelect, icon, text}) => (
    <div onClick={() => onSelect(panel)} className={"settings--item " + (selected === panel ? "selected" : "")}>
        <span className={"settings--item--icon"}><FontAwesomeIcon icon={icon}/></span>
