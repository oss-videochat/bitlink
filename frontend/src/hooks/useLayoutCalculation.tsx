...
export function useLayoutCalculation(param1: number | (() => number), container: RefObject<HTMLDivElement>){
    ...
    useEffect(() => {
        return reaction(() => {
            ...
            const result = LayoutSizeCalculation(divWidth, container.current.offsetHeight, data.numTiles);
